...
def decode_segmap(image, source, bgimg, nc=21):
  ...
  outImage2save = cv2.cvtColor( outImage.astype('float32'), cv2.COLOR_BGR2RGB) 
  cv2.imwrite("outImage_" + str(source), outImage2save)
...
cv2.imwrite("white_background.jpg", makeGreenScreen(width=1000, height=1000, bgr_color=(255, 255, 255) ))
#custom
segment(dlab, 'pf3.jpeg','./images/change/background-building.png', show_orig=False)

segment(dlab, 'pf3.jpeg',"white_background.jpg", show_orig=False)
