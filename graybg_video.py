...
def grey_background_decode_segmap(image, source, sourceFromPath=False, nc=21):
...
def grey_background_segment(net, seg_source, show_orig=False, dev='cuda'):
  ...
  rgb = grey_background_decode_segmap(om, seg_source)
...
while 1:
    ...
    changed_img = grey_background_segment(net=dlab, seg_source=img2segment, show_orig=False, dev='cuda')
